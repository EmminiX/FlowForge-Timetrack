...
import { Button, Card, EmptyState, ConfirmDialog, Input, Textarea, Modal, ModalFooter } from '../../components/ui';
                ...
                >
                    <div className="space-y-4">
                        ...
                        <div className="prose prose-sm dark:prose-invert max-w-none bg-secondary/50 p-4 rounded-lg">
                            <p className="whitespace-pre-wrap">{viewingProduct.description || 'No description provided.'}</p>
                        </div>

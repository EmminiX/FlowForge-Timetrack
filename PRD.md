# TimeSage - Product Requirements Document

## Overview

TimeSage is a **neurodivergent-friendly time tracking and invoicing application** for freelancers. Built with Tauri + React for cross-platform desktop support (macOS, Windows, Linux).
...
- Create invoice flow:
  1. Select client
  2. Choose projects → import unbilled hours
